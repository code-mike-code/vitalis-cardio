import styles from './FacebookWidget.module.scss'

const FB_URL = 'https://www.facebook.com/share/1CbySfFVPo/'
...
function FacebookWidget() {
  return (
    <a
      ...
      aria-label="Vitalis na Facebook (otwiera w nowej karcie)"
    >
